...
const iconMap: { [key: string]: React.ElementType } = {
  ...
  Home, Zap, Music, Plane, Gift, Coffee, Laptop, Smartphone, Wifi, Droplets, Fuel,
  Bus, Train, Bike, ShoppingCart, ShoppingBasket, Apple, Pizza, Wine, Cake, Cookie,
  BookOpen, Pencil, Calculator, Briefcase, Building, Banknote, CreditCard, Wallet,
  PiggyBank, Target, Trophy, Medal, Star, HeartHandshake, HandHeart, Users, Baby,
  Dog, Cat, Leaf, Sun, Cloud, Umbrella, Tv, Film, Clapperboard, Headphones, Mic2,
  Guitar, Dumbbell, Basketball, Football, TennisBall, Swim, Bike,
